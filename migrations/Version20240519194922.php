 ...
 */
final class Version20240519194922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD seance_id INT NOT NULL, CHANGE user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP seance_id, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
